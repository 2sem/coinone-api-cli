...
import type { DoctorReport, EmitResult, PrivateAuthEnv } from '../lib/types.js';
...
export function createDoctorCommand(
  dependencies: CreateDoctorCommandDependencies = {},
...
function buildDoctorReport(dependencies: CreateDoctorCommandDependencies): DoctorReport {
