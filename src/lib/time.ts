...
export function parseTimestampInput(value: string, flagName: string): number {
...
export function validateTimeWindow(fromValue: string, toValue: string): TimeWindow {
...
export function maxCompletedOrderWindowMs(): number {
